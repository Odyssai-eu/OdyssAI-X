...
| ml-explore/mlx-lm | 1788 | comment | Qwen3.8-Flash-Next (qwen4_exp) support | merge; we run our own carve-out (mlx_models/qwen4_exp) until then; seed 0 vs reference 1234 (sje397, 2026-09-26) checked on our side in forge #92 | 2026-09-26 | re-test against the branch when it merges, drop our carve-out | - |
