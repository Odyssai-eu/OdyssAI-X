# VENDORISÉ depuis Blaizzy/mlx-vlm main (mlx_vlm/models/gated_delta.py,
# 2026-08-26) — variante du gated_delta de mlx-lm avec le safe-gate KDA
# (`lower_bound`, requis par glm5_next). Fichier dédié pour ne PAS écraser le
# mlx_lm/models/gated_delta.py stock que qwen3_next/qwen4_exp utilisent.
