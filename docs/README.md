...
- [**CoeOS**](https://github.com/Odyssai-eu/coeos) — the smart client and AI operating system (smart router included) that sits on this engine; its user guide is [`doc/USER-GUIDE.md`](https://github.com/Odyssai-eu/coeos-box/blob/main/doc/USER-GUIDE.md) in that repo.
